...
GDparams.etamin = 1e-3;
GDparams.etamax = GDparams.etamin;
GDparams.etamax = 1e-3;
GDparams.nCycles = 6;
...
function Thetaopt = MiniBatchGD(Xtrain, Ytrain, Xdev, Ydev, GDparams, Theta, lambda)
    ...
    for epoch = 1:n_epochs
        ...
        for j=1:N/n_batch
                ...
                snr = 20;
                disturbedsignal = awgn(Xbatch,snr);
                
                [grad_b, grad_W] = ComputeGradients(disturbedsignal, Ybatch,activationVals, Theta, lambda);
